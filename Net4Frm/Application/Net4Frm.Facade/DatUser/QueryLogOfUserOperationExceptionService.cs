...
{
   public class QueryLogOfUserOperationExceptionService : BaseService<IOperationSysDatUser>
    {
        #region 获取用户操作日志
        /// <summary>
        /// 获取用户操作日志
        ...
        /// <returns></returns>
       public QueryLogOfUserOperationExceptionRes Any(QueryLogOfUserOperationExceptionReq req)
        {
            ...
            try
            {
                ...
                long total = 0;
                var resule = ServiceImpl.SearchUserOperationException(data, pageIndex, pageSize, out total);
                return new QueryLogOfUserOperationExceptionRes
                {     
                    DoFlag = true,
